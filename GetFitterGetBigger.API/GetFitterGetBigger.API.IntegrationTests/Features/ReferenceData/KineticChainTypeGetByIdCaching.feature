Feature: KineticChainType GetById Caching
  As a system administrator
  I want kinetic chain type GetById to be cached properly
  ...
  Scenario: Calling get kinetic chain type by ID twice should only hit database once
