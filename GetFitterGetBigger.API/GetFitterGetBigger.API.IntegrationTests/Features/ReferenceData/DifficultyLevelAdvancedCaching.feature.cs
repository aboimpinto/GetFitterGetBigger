...
namespace GetFitterGetBigger.API.IntegrationTests.Features.ReferenceData
{
    ...
    public partial class DifficultyLevelAdvancedCachingFeature : object, Xunit.IClassFixture<DifficultyLevelAdvancedCachingFeature.FixtureData>, Xunit.IAsyncLifetime
    {
        ...
        public DifficultyLevelAdvancedCachingFeature(DifficultyLevelAdvancedCachingFeature.FixtureData fixtureData, Xunit.Abstractions.ITestOutputHelper testOutputHelper)
        {
        ...
        public static async System.Threading.Tasks.Task FeatureSetupAsync()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features/ReferenceData", "Difficulty Level Advanced Caching", "  As a system administrator\n  I want difficulty level data to be cached properly " +
        ...
        [Xunit.SkippableFactAttribute(DisplayName="Different difficulty level IDs should result in separate cache entries")]
        [Xunit.TraitAttribute("FeatureTitle", "Difficulty Level Advanced Caching")]
        [Xunit.TraitAttribute("Description", "Different difficulty level IDs should result in separate cache entries")]
        [Xunit.TraitAttribute("Category", "caching")]
        [Xunit.TraitAttribute("Category", "reference-data")]
        public async System.Threading.Tasks.Task DifferentDifficultyLevelIDsShouldResultInSeparateCacheEntries()
        {
            string[] tagsOfScenario = new string[] {
                    "caching",
                    "reference-data"};
            System.Collections.Specialized.OrderedDictionary argumentsOfScenario = new System.Collections.Specialized.OrderedDictionary();
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Different difficulty level IDs should result in separate cache entries", null, tagsOfScenario, argumentsOfScenario, featureTags);
            ...
            else
            {
                ...
                await testRunner.AndAsync("I store the second item from the response as \"secondDifficultyLevel\"", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
                ...
                await testRunner.AndAsync("the response property \"id\" should be \"<firstDifficultyLevel.id>\"", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
                await testRunner.WhenAsync("I send a GET request to \"/api/ReferenceTables/DifficultyLevels/<secondDifficultyL" +
                        "evel.id>\"", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
                await testRunner.ThenAsync("the response status should be 200", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
                await testRunner.AndAsync("the response property \"id\" should be \"<secondDifficultyLevel.id>\"", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
                await testRunner.WhenAsync("I send a GET request to \"/api/ReferenceTables/DifficultyLevels/<firstDifficultyLe" +
                        "vel.id>\"", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
                await testRunner.ThenAsync("the response status should be 200", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
                await testRunner.AndAsync("the response property \"id\" should be \"<firstDifficultyLevel.id>\"", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
        ...
        public async System.Threading.Tasks.Task GetByValueShouldAlsoUseCache()
        {
            ...
            else
            {
                ...
                await testRunner.WhenAsync("I send a GET request to \"/api/ReferenceTables/DifficultyLevels/ByValue/Beginner\"", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
                await testRunner.ThenAsync("the response status should be 200", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
        ...
        public class FixtureData : object, Xunit.IAsyncLifetime
        {
            ...
            async System.Threading.Tasks.Task Xunit.IAsyncLifetime.InitializeAsync()
            {
                await DifficultyLevelAdvancedCachingFeature.FeatureSetupAsync();
            }
            
            async System.Threading.Tasks.Task Xunit.IAsyncLifetime.DisposeAsync()
            {
                await DifficultyLevelAdvancedCachingFeature.FeatureTearDownAsync();
            }
        }
    }
}
