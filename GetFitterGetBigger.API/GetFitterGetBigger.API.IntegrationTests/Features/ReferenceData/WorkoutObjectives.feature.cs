    ...
    public partial class WorkoutObjectivesReferenceDataFeature : object, Xunit.IClassFixture<WorkoutObjectivesReferenceDataFeature.FixtureData>, Xunit.IAsyncLifetime
    {
        ...
        public virtual async System.Threading.Tasks.Task FeatureBackgroundAsync()
        {
            ...
            table19.AddRow(new string[] {
                        ...
                        "5",
                        "false"});
            await testRunner.GivenAsync("the following workout objectives exist in the database:", ((string)(null)), table19, "Given ");
        }
        ...
        public async System.Threading.Tasks.Task GetAllActiveWorkoutObjectives()
        {
            ...
            else
            {
                ...
                table20.AddRow(new string[] {
                            ...
                            "boolean",
                            "true"});
                await testRunner.AndAsync("each workout objective should have the following fields:", ((string)(null)), table20, "And ");
        ...
        public async System.Threading.Tasks.Task GetWorkoutObjectiveByValidID()
        {
            ...
            else
            {
                ...
                table21.AddRow(new string[] {
                            "isActive",
                            "true"});
                await testRunner.AndAsync("the response should contain a workout objective with:", ((string)(null)), table21, "And ");
            }
            await this.ScenarioCleanupAsync();
        }
        ...
        public async System.Threading.Tasks.Task GetWorkoutObjectiveByNon_ExistentID()
        {
            ...
            else
            {
                ...
                await testRunner.AndAsync("the response should contain an error with:", ((string)(null)), table22, "And ");
            }
            await this.ScenarioCleanupAsync();
        }
        ...
        public async System.Threading.Tasks.Task GetWorkoutObjectiveWithInvalidIDFormat()
        {
            ...
            else
            {
                ...
                table23.AddRow(new string[] {
                            "message",
                            "Workout objective not found"});
                await testRunner.AndAsync("the response should contain an error with:", ((string)(null)), table23, "And ");
            }
            await this.ScenarioCleanupAsync();
        }
        ...
        public async System.Threading.Tasks.Task GetInactiveWorkoutObjectiveByIDWithoutIncludeInactiveFlag()
        {
            ...
            else
            {
                ...
                table24.AddRow(new string[] {
                            "message",
                            "Workout objective not found"});
                await testRunner.AndAsync("the response should contain an error with:", ((string)(null)), table24, "And ");
            }
            await this.ScenarioCleanupAsync();
        }
        ...
        public async System.Threading.Tasks.Task GetInactiveWorkoutObjectiveByIDWithIncludeInactiveFlag()
        {
            ...
            else
            {
                ...
                table25.AddRow(new string[] {
                            "isActive",
                            "false"});
                await testRunner.AndAsync("the response should contain a workout objective with:", ((string)(null)), table25, "And ");
            }
            await this.ScenarioCleanupAsync();
        }
