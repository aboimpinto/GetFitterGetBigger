Feature: Workout Objective Caching
  As a system administrator
  I want workout objective data to be cached
  ...
  Scenario: Calling get all workout objectives twice should only hit database once
