Feature: Workout Objectives Reference Data
  ...
  Scenario: Get workout objective by valid ID
    When I send a GET request to "/api/workout-objectives/workoutobjective-10000001-1000-4000-8000-100000000001"
    Then the response status should be 200
    And the response should contain a workout objective with:
      | Field        | Value                                                          |
      | workoutObjectiveId | workoutobjective-10000001-1000-4000-8000-100000000001         |
