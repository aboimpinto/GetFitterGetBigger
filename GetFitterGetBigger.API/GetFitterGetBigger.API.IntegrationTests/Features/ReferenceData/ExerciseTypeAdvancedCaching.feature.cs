...
namespace GetFitterGetBigger.API.IntegrationTests.Features.ReferenceData
{
    ...
    public partial class ExerciseTypesAdvancedCachingFeature : object, Xunit.IClassFixture<ExerciseTypesAdvancedCachingFeature.FixtureData>, Xunit.IAsyncLifetime
    {
        ...
        public ExerciseTypesAdvancedCachingFeature(ExerciseTypesAdvancedCachingFeature.FixtureData fixtureData, Xunit.Abstractions.ITestOutputHelper testOutputHelper)
        {
        ...
        public static async System.Threading.Tasks.Task FeatureSetupAsync()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features/ReferenceData", "Exercise Types Advanced Caching", "  As a system administrator\n  I want exercise types data to be cached properly fo" +
        ...
        [Xunit.TraitAttribute("Category", "caching")]
        [Xunit.TraitAttribute("Category", "reference-data")]
        public async System.Threading.Tasks.Task DifferentExerciseTypeIDsShouldResultInSeparateCacheEntries()
        {
            string[] tagsOfScenario = new string[] {
                    "caching",
                    "reference-data"};
            System.Collections.Specialized.OrderedDictionary argumentsOfScenario = new System.Collections.Specialized.OrderedDictionary();
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Different exercise type IDs should result in separate cache entries", null, tagsOfScenario, argumentsOfScenario, featureTags);
            this.ScenarioInitialize(scenarioInfo);
            if ((TagHelper.ContainsIgnoreTag(tagsOfScenario) || TagHelper.ContainsIgnoreTag(featureTags)))
            {
                testRunner.SkipScenario();
            ...
            else
            {
                ...
                await testRunner.AndAsync("I send a GET request to \"/api/ReferenceTables/ExerciseTypes\"", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
                await testRunner.AndAsync("the response contains at least 2 items", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
                await testRunner.AndAsync("I store the first item from the response as \"firstExerciseType\"", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
                await testRunner.AndAsync("I store the second item from the response as \"secondExerciseType\"", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
                await testRunner.WhenAsync("I send a GET request to \"/api/ReferenceTables/ExerciseTypes/<firstExerciseType.id" +
                        ">\"", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
                await testRunner.ThenAsync("the response status should be 200", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
                await testRunner.AndAsync("the response property \"id\" should be \"<firstExerciseType.id>\"", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
                await testRunner.WhenAsync("I send a GET request to \"/api/ReferenceTables/ExerciseTypes/<secondExerciseType.i" +
                        "d>\"", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
                await testRunner.ThenAsync("the response status should be 200", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
                await testRunner.AndAsync("the response property \"id\" should be \"<secondExerciseType.id>\"", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
                await testRunner.WhenAsync("I send a GET request to \"/api/ReferenceTables/ExerciseTypes/<firstExerciseType.id" +
                        ">\"", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
                await testRunner.ThenAsync("the response status should be 200", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
                await testRunner.AndAsync("the response property \"id\" should be \"<firstExerciseType.id>\"", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
        ...
        public class FixtureData : object, Xunit.IAsyncLifetime
        {
            ...
            async System.Threading.Tasks.Task Xunit.IAsyncLifetime.InitializeAsync()
            {
                await ExerciseTypesAdvancedCachingFeature.FeatureSetupAsync();
            }
            
            async System.Threading.Tasks.Task Xunit.IAsyncLifetime.DisposeAsync()
            {
                await ExerciseTypesAdvancedCachingFeature.FeatureTearDownAsync();
            }
        }
    }
}
