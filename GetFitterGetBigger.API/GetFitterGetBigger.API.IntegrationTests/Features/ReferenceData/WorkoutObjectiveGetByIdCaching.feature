Feature: WorkoutObjective GetById Caching
  As a system administrator
  I want workout objective GetById to be cached properly
  ...
  Scenario: Calling get workout objective by ID twice should only hit database once
