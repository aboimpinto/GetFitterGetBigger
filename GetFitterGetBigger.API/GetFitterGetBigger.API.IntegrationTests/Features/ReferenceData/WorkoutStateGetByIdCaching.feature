Feature: WorkoutState GetById Caching
  As a system administrator
  I want workout state GetById to be cached properly
  ...
  Scenario: Calling get workout state by ID twice should only hit database once
