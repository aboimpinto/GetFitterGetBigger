...
namespace GetFitterGetBigger.API.IntegrationTests.Features.ReferenceData
{
    ...
    public partial class ExerciseTypeGetByIdCachingFeature : object, Xunit.IClassFixture<ExerciseTypeGetByIdCachingFeature.FixtureData>, Xunit.IAsyncLifetime
    {
        ...
        public ExerciseTypeGetByIdCachingFeature(ExerciseTypeGetByIdCachingFeature.FixtureData fixtureData, Xunit.Abstractions.ITestOutputHelper testOutputHelper)
        {
        ...
        public static async System.Threading.Tasks.Task FeatureSetupAsync()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features/ReferenceData", "ExerciseType GetById Caching", "  As a system administrator\n  I want exercise type GetById to be cached properly\n" +
        ...
        [Xunit.TraitAttribute("FeatureTitle", "ExerciseType GetById Caching")]
        ...
        public class FixtureData : object, Xunit.IAsyncLifetime
        {
            ...
            async System.Threading.Tasks.Task Xunit.IAsyncLifetime.InitializeAsync()
            {
                await ExerciseTypeGetByIdCachingFeature.FeatureSetupAsync();
            }
            
            async System.Threading.Tasks.Task Xunit.IAsyncLifetime.DisposeAsync()
            {
                await ExerciseTypeGetByIdCachingFeature.FeatureTearDownAsync();
            }
        }
    }
}
