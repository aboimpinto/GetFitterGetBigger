Feature: MuscleRole GetById Caching
  As a system administrator
  I want muscle role GetById to be cached properly
  ...
  Scenario: Calling get muscle role by ID twice should only hit database once
