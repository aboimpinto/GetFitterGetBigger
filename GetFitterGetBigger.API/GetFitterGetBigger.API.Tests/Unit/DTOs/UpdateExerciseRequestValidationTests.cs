...
public class UpdateExerciseRequestValidationTests
{
    ...
    [Fact]
    public void UpdateExerciseRequest_NonRestExercise_EmptyMuscleGroups_IsValidAtDtoLevel()
    {
    ...
    [Fact]
    public void UpdateExerciseRequest_EmptyExerciseTypes_EmptyMuscleGroups_IsValidAtDtoLevel()
    {
        // Arrange - DTO validation no longer checks muscle groups (moved to service layer)
        var request = new UpdateExerciseRequest
            {
    ...
    public void UpdateExerciseRequest_NonRestExerciseTypes_EmptyMuscleGroups_IsValidAtDtoLevel(string exerciseTypeId)
    {
        // Arrange - DTO validation no longer checks muscle groups (moved to service layer)
        var request = new UpdateExerciseRequest
        {
