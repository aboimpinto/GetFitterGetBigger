...
public class CreateExerciseRequestValidationTests
{
    [Fact]
    public void CreateExerciseRequest_RestExercise_EmptyMuscleGroups_IsValid()
    {
        // Arrange
    ...
    [Fact]
    public void CreateExerciseRequest_NonRestExercise_WithMuscleGroups_IsValid()
    {
        // Arrange
        var request = new CreateExerciseRequest
        {
    ...
    [InlineData("exercisetype-Rest-456")]
    [InlineData("exercisetype-rEsT-456")]
    public void CreateExerciseRequest_RestExercise_CaseInsensitive_EmptyMuscleGroups_IsValid(string restExerciseTypeId)
    {
        // Arrange
        var request = new CreateExerciseRequest
        {
    ...
    [Fact]
    public void CreateExerciseRequest_RequiredFields_Validation()
    {
        // Arrange
        var request = new CreateExerciseRequest
        {
    ...
    [Fact]
    public void CreateExerciseRequest_RestExercise_WithMuscleGroups_IsValid()
    {
