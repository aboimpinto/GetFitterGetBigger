...
/// <summary>
/// Data service implementation for ExerciseWeightType database operations
/// Manages all data access concerns including UnitOfWork and Repository interactions
/// </summary>
public class ExerciseWeightTypeDataService : IExerciseWeightTypeDataService
{
    private readonly IUnitOfWorkProvider<FitnessDbContext> _unitOfWorkProvider;
    private readonly ILogger<ExerciseWeightTypeDataService> _logger;

    public ExerciseWeightTypeDataService(
        IUnitOfWorkProvider<FitnessDbContext> unitOfWorkProvider,
        ILogger<ExerciseWeightTypeDataService> logger)
    {
    ...
    public async Task<ServiceResult<IEnumerable<ReferenceDataDto>>> GetAllActiveAsync()
    {
        ...
        _logger.LogInformation("Loaded {Count} active exercise weight types from database", dtos.Count);
    ...
    public async Task<ServiceResult<ReferenceDataDto>> GetByIdAsync(ExerciseWeightTypeId id)
    {
        ...
        _logger.LogDebug("Retrieved exercise weight type by ID {Id}: {Found}", id, !dto.IsEmpty);
    ...
    public async Task<ServiceResult<ReferenceDataDto>> GetByValueAsync(string value)
    {
        ...
        _logger.LogDebug("Retrieved exercise weight type by value '{Value}': {Found}", value, !dto.IsEmpty);
        return ServiceResult<ReferenceDataDto>.Success(dto);
    }
    ...
    public async Task<ServiceResult<ReferenceDataDto>> GetByCodeAsync(string code)
    {
        ...
        _logger.LogDebug("Retrieved exercise weight type by code '{Code}': {Found}", code, !dto.IsEmpty);
        return ServiceResult<ReferenceDataDto>.Success(dto);
    }
    ...
    public async Task<ServiceResult<BooleanResultDto>> ExistsAsync(ExerciseWeightTypeId id)
    {
        ...
        _logger.LogDebug("Checked existence of exercise weight type {Id}: {Exists}", id, exists);
    ...
    /// </summary>
    private static ReferenceDataDto MapToDto(Models.Entities.ExerciseWeightType entity)
    {
        if (entity.IsEmpty)
