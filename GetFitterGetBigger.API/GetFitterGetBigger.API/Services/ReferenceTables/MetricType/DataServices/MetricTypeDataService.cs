...
/// <summary>
/// Data service implementation for MetricType database operations
/// Manages all data access concerns including UnitOfWork and Repository interactions
/// </summary>
public class MetricTypeDataService : IMetricTypeDataService
{
    private readonly IUnitOfWorkProvider<FitnessDbContext> _unitOfWorkProvider;
    private readonly ILogger<MetricTypeDataService> _logger;

    public MetricTypeDataService(
        IUnitOfWorkProvider<FitnessDbContext> unitOfWorkProvider,
        ILogger<MetricTypeDataService> logger)
    {
    ...
    public async Task<ServiceResult<IEnumerable<ReferenceDataDto>>> GetAllActiveAsync()
    {
        ...
        _logger.LogInformation("Loaded {Count} active metric types from database", dtos.Count);
    ...
    public async Task<ServiceResult<ReferenceDataDto>> GetByIdAsync(MetricTypeId id)
    {
        ...
        _logger.LogDebug("Retrieved metric type by ID {Id}: {Found}", id, !dto.IsEmpty);
    ...
    public async Task<ServiceResult<ReferenceDataDto>> GetByValueAsync(string value)
    {
        ...
        _logger.LogDebug("Retrieved metric type by value '{Value}': {Found}", value, !dto.IsEmpty);
        return ServiceResult<ReferenceDataDto>.Success(dto);
    }
    ...
    public async Task<ServiceResult<BooleanResultDto>> ExistsAsync(MetricTypeId id)
    {
        ...
        _logger.LogDebug("Checked existence of metric type {Id}: {Exists}", id, exists);
    ...
    /// </summary>
    private static ReferenceDataDto MapToDto(Models.Entities.MetricType entity)
    {
        if (entity.IsEmpty)
