...
namespace GetFitterGetBigger.API.Migrations
{
    ...
    [Migration("20250820232711_UpdateExerciseLinksForFourWaySystem")]
    partial class UpdateExerciseLinksForFourWaySystem
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GetFitterGetBigger.API.Models.Entities.SetConfiguration", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("GetFitterGetBigger.API.Models.Entities.WorkoutTemplate", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("GetFitterGetBigger.API.Models.Entities.WorkoutTemplateExercise", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("WorkoutTemplateId", "Zone", "SequenceOrder")
                        .IsUnique()
            ...
            modelBuilder.Entity("GetFitterGetBigger.API.Models.Entities.WorkoutTemplateObjective", b =>
                {
                    b.Property<Guid>("WorkoutTemplateId")
                        .HasColumnType("uuid");
                    ...
                    b.HasKey("WorkoutTemplateId", "WorkoutObjectiveId");

                    b.HasIndex("WorkoutObjectiveId");

                    b.ToTable("WorkoutTemplateObjectives");
                });
            ...
            modelBuilder.Entity("GetFitterGetBigger.API.Models.Entities.SetConfiguration", b =>
                {
                    b.HasOne("GetFitterGetBigger.API.Models.Entities.WorkoutTemplateExercise", "WorkoutTemplateExercise")
            ...
            modelBuilder.Entity("GetFitterGetBigger.API.Models.Entities.WorkoutTemplate", b =>
                {
                    b.HasOne("GetFitterGetBigger.API.Models.Entities.WorkoutCategory", "Category")
                        .WithMany()
            ...
            modelBuilder.Entity("GetFitterGetBigger.API.Models.Entities.WorkoutTemplateExercise", b =>
                {
                    ...
                    b.HasOne("GetFitterGetBigger.API.Models.Entities.WorkoutTemplate", "WorkoutTemplate")
                        .WithMany("Exercises")
            ...
            modelBuilder.Entity("GetFitterGetBigger.API.Models.Entities.WorkoutTemplateObjective", b =>
                {
                    b.HasOne("GetFitterGetBigger.API.Models.Entities.WorkoutObjective", "WorkoutObjective")
                        .WithMany()
                        .HasForeignKey("WorkoutObjectiveId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
