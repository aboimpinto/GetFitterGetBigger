...
- **Task 5.2:** Write integration tests for ExercisesController `[Implemented: 3d23275f]` (tests now passing - BUG-002 fixed by FEAT-007)
- **Task 5.3:** ~~Add [Authorize] attribute for admin-only access~~ `[REMOVED]` - Authorization handled by FEAT-010
...
- Authorization requirements removed (handled by FEAT-010)
- BUG-002 (skipped tests) resolved by FEAT-007