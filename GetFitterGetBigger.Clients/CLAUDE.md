...
## Role in Clients Project

When working in the Clients project folder, the AI assistant can perform **full implementation work** including:
- Creating platform-specific components (Mobile, Web, Desktop)
- Implementing features across platforms
- Writing tests
