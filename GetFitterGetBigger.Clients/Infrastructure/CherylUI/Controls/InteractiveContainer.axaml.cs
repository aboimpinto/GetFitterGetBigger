...
public partial class InteractiveContainer : UserControl
{
    ...
    public static readonly StyledProperty<object> DialogContentProperty = AvaloniaProperty.Register<InteractiveContainer, object>(nameof(InteractiveContainer), defaultValue: new Grid());
    ...
    public static void ShowDialog(object content, bool showAtBottom = false)
    {
        var container = GetInteractiveContainerInstance();
